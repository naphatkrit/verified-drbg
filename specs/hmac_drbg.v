...
Definition _mbedtls_hmac_drbg_update : ident := 110%positive.
Definition _use_len : ident := 130%positive.
Definition _data_len : ident := 111%positive.
...
Definition _md_name : ident := 79%positive.
Definition _memcpy : ident := 72%positive.
Definition _K : ident := 109%positive.
Definition _mocked_sha256_info : ident := 78%positive.
...
Definition _mbedtls_md_info_from_type : ident := 82%positive.
...
Definition _output : ident := 96%positive.
...
Definition _mbedtls_md_hmac_update : ident := 95%positive.
...
Definition _mbedtls_md_hmac_reset : ident := 92%positive.
...
Definition _ilen : ident := 94%positive.
...
Definition _mbedtls_md_info_from_string : ident := 80%positive.
...
Definition _input : ident := 93%positive.
...
Definition _HMAC_cleanup : ident := 77%positive.
...
(Ssequence
  (Ssequence
    ...
    (Sset _sha_ctx
      (Ecast (Etempvar 135%positive (tptr tvoid))
...
Definition f_mbedtls_zeroize := {|
  ...
  fn_temps := ((_p, (tptr (tvolatile tuchar))) ::
               (137%positive, (tptr (tvolatile tuchar))) ::
               (136%positive, tuint) :: nil);
  fn_body :=
(Ssequence
  ...
  (Sloop
    (Ssequence
      (Ssequence
        (Ssequence
          (Sset 136%positive (Etempvar _n tuint))
          (Sset _n
            (Ebinop Osub (Etempvar 136%positive tuint)
              (Econst_int (Int.repr 1) tint) tuint)))
        (Sifthenelse (Etempvar 136%positive tuint) Sskip Sbreak))
      (Ssequence
        (Ssequence
          (Sset 137%positive (Etempvar _p (tptr (tvolatile tuchar))))
          (Sset _p
            (Ebinop Oadd (Etempvar 137%positive (tptr (tvolatile tuchar)))
        ...
        (Sbuiltin None (EF_vstore Mint8unsigned)
          ...
          ((Eaddrof
             (Ederef (Etempvar 137%positive (tptr (tvolatile tuchar)))
    ...
    (Ssequence
      (Ssequence
        (Sifthenelse (Ebinop One (Etempvar _additional (tptr tuchar))
          ...
          (Sset 139%positive (Econst_int (Int.repr 0) tint)))
        (Sifthenelse (Etempvar 139%positive tint)
          (Sset 140%positive (Ecast (Econst_int (Int.repr 2) tint) tint))
          (Sset 140%positive (Ecast (Econst_int (Int.repr 1) tint) tint))))
      (Sset _rounds (Ecast (Etempvar 140%positive tint) tuchar)))
    (Ssequence
      (Sassign
        (Ederef
...
Definition f_mbedtls_hmac_drbg_seed_buf := {|
  ...
  fn_vars := nil;
  fn_temps := ((_ret, tint) :: (144%positive, tuchar) ::
               (143%positive, tuchar) :: (142%positive, tint) ::
               (141%positive, tint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Ssequence
    ...
    (Sifthenelse (Ebinop One (Ecast (Etempvar 142%positive tint) tint)
        ...
        ((Eaddrof
         ...
         (Efield
           (Ederef
             (Etempvar _ctx (tptr (Tstruct _mbedtls_hmac_drbg_context noattr)))
             (Tstruct _mbedtls_hmac_drbg_context noattr)) _V
           (tarray tuchar 32)) :: (Etempvar 143%positive tuchar) :: nil)))
    (Ssequence
      (Ssequence
        ...
        (Scall None
          ...
          ((Efield
           ...
           (Etempvar 144%positive tuchar) :: nil)))
      (Ssequence
        (Scall None
...
Definition f_mbedtls_hmac_drbg_reseed := {|
  ...
  fn_temps := ((_seedlen, tuint) :: (147%positive, tint) ::
               (146%positive, tint) :: (145%positive, tint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sifthenelse (Ebinop Ogt (Etempvar _len tuint)
                   (Econst_int (Int.repr 256) tint) tint)
      (Sset 145%positive (Econst_int (Int.repr 1) tint))
      (Sset 145%positive
        (Ecast
          (Ebinop Ogt
            (Ebinop Oadd
          ...
          ((Efield
           ...
           (Efield
             (Ederef
               ...
               (Tstruct _mbedtls_hmac_drbg_context noattr)) _entropy_len
             tuint) :: nil))
        (Sifthenelse (Ebinop One (Etempvar 146%positive tint)
                       (Econst_int (Int.repr 0) tint) tint)
...
Definition f_mbedtls_hmac_drbg_seed := {|
  ...
  fn_temps := ((_ret, tint) :: (_entropy_len, tuint) :: (_md_size, tuint) ::
               ...
               (152%positive, tint) :: (151%positive, tint) ::
               (150%positive, tuchar) :: (149%positive, tint) ::
      ...
      (Ssequence
        (Scall (Some 148%positive)
          ...
          ((Eaddrof
           ...
           (Etempvar _md_info (tptr (Tstruct _mbedtls_md_info_t noattr))) ::
           (Econst_int (Int.repr 1) tint) :: nil))
        (Sset 149%positive (Etempvar 148%positive tint)))
      (Sset _ret (Etempvar 149%positive tint)))
    (Sifthenelse (Ebinop One (Ecast (Etempvar 149%positive tint) tint)
                   (Econst_int (Int.repr 0) tint) tint)
      (Sreturn (Some (Etempvar _ret tint)))
      Sskip))
  (Ssequence
    (Ssequence
      (Scall (Some 150%positive)
        ...
        ((Etempvar _md_info (tptr (Tstruct _mbedtls_md_info_t noattr))) ::
         nil))
      (Sset _md_size (Etempvar 150%positive tuchar)))
    (Ssequence
      (Scall None
        (Evar _mbedtls_md_hmac_starts (Tfunction
                                        (Tcons
                  ...
                  (Sifthenelse (Ebinop Ole (Etempvar _md_size tuint)
                    ...
                    (Sifthenelse (Ebinop Ole (Etempvar _md_size tuint)
                      ...
                      (Ssequence
                        ...
                        (Sset 151%positive
                          (Ecast (Etempvar 152%positive tint) tint)))
                      (Ssequence
                        (Sset 152%positive
                          (Ecast (Econst_int (Int.repr 32) tint) tint))
                        (Sset 151%positive
                          (Ecast (Etempvar 152%positive tint) tint)))))
                  (Sset _entropy_len (Etempvar 151%positive tint)))
                (Ssequence
                  (Sassign
                    (Efield
                      (Ederef
                        ...
                        (Ssequence
                          (Scall (Some 153%positive)
                            ...
                            ((Etempvar _ctx (tptr (Tstruct _mbedtls_hmac_drbg_context noattr))) ::
                             ...
                             (Etempvar _len tuint) :: nil))
                          (Sset 154%positive (Etempvar 153%positive tint)))
                        (Sset _ret (Etempvar 154%positive tint)))
                      (Sifthenelse (Ebinop One
                                     (Ecast (Etempvar 154%positive tint)
...
Definition f_mbedtls_hmac_drbg_random_with_add := {|
  ...
  fn_temps := ((_ret, tint) ::
               ...
               (_use_len, tuint) :: (160%positive, tuint) ::
               (159%positive, tint) :: (158%positive, tint) ::
               (157%positive, tint) :: (156%positive, tint) ::
               (155%positive, tuchar) :: nil);
  fn_body :=
(Ssequence
  (Sset _ctx
      ...
      (Scall (Some 155%positive)
        ...
        ((Efield
           (Efield
             ...
             (Tstruct _mbedtls_md_context_t noattr)) _md_info
           (tptr (Tstruct _mbedtls_md_info_t noattr))) :: nil))
      (Sset _md_len (Etempvar 155%positive tuchar)))
    (Ssequence
                ...
                (Sifthenelse (Ebinop One
                  ...
                  (Sifthenelse (Ebinop Oeq
                    ...
                    (Ssequence
                      ...
                      (Sset 158%positive
                        (Ecast (Etempvar 158%positive tint) tbool))))
                  (Sset 158%positive (Econst_int (Int.repr 0) tint)))
                (Sifthenelse (Etempvar 158%positive tint)
                  (Ssequence
                    (Ssequence
                      (Ssequence
                        (Ssequence
                          (Scall (Some 156%positive)
                            ...
                            ((Etempvar _ctx (tptr (Tstruct _mbedtls_hmac_drbg_context noattr))) ::
                             (Etempvar _additional (tptr tuchar)) ::
                             (Etempvar _add_len tuint) :: nil))
                          (Sset 157%positive (Etempvar 156%positive tint)))
                        (Sset _ret (Etempvar 157%positive tint)))
                      (Sifthenelse (Ebinop One
                                     (Ecast (Etempvar 157%positive tint)
                                       tint) (Econst_int (Int.repr 0) tint)
                                     tint)
                        (Sreturn (Some (Etempvar _ret tint)))
                        Sskip))
                  ...
                  (Sifthenelse (Ebinop One
                    ...
                    (Sset 159%positive
                      (Ecast
                        (Ebinop One (Etempvar _add_len tuint)
                          (Econst_int (Int.repr 0) tint) tint) tbool))
                    (Sset 159%positive (Econst_int (Int.repr 0) tint)))
                  ...
                  (Swhile
                    ...
                    (Ssequence
                      (Ssequence
                        ...
                        (Sset _use_len (Etempvar 160%positive tuint)))
                      (Ssequence
                        (Scall None
                          (Evar _mbedtls_md_hmac_reset (Tfunction
                                                         (Tcons
    ...
    (Ssequence
      (Scall (Some 161%positive)
        ...
        ((Etempvar _ctx (tptr (Tstruct _mbedtls_hmac_drbg_context noattr))) ::
         ...
         (Ecast (Econst_int (Int.repr 0) tint) (tptr tvoid)) ::
         (Econst_int (Int.repr 0) tint) :: nil))
      (Sset _ret (Etempvar 161%positive tint)))
    (Sreturn (Some (Etempvar _ret tint)))))
|}.
...
(_main :: _mbedtls_hmac_drbg_free :: _mbedtls_hmac_drbg_random ::
 ...
 _HMAC_Update :: _HMAC_Init :: _memset :: _memcpy :: _free :: _malloc ::
