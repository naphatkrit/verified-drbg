...
Definition _mbedtls_zeroize : ident := 85%positive.
Definition _mbedtls_md_info_from_string : ident := 65%positive.
Definition ___i64_sdiv : ident := 40%positive.
Definition _left : ident := 112%positive.
Definition _p_rng : ident := 110%positive.
...
Definition _ctx : ident := 69%positive.
Definition _memset : ident := 62%positive.
Definition ___builtin_fmin : ident := 54%positive.
Definition _out_len : ident := 111%positive.
Definition ___builtin_memcpy_aligned : ident := 22%positive.
Definition _V : ident := 12%positive.
Definition _K : ident := 92%positive.
Definition _interval : ident := 108%positive.
Definition _mbedtls_hmac_drbg_seed : ident := 104%positive.
...
Definition _add_len : ident := 88%positive.
Definition _output : ident := 79%positive.
Definition _key : ident := 72%positive.
...
Definition _mbedtls_hmac_drbg_set_reseed_interval : ident := 109%positive.
Definition _mbedtls_md_hmac_update : ident := 78%positive.
Definition _data : ident := 94%positive.
...
Definition _out : ident := 113%positive.
Definition _custom : ident := 102%positive.
Definition _mbedtls_md_info_t : ident := 7%positive.
Definition _md_size : ident := 103%positive.
Definition _seed : ident := 99%positive.
Definition ___builtin_fabs : ident := 21%positive.
Definition _p_entropy : ident := 18%positive.
Definition _mbedtls_hmac_drbg_reseed : ident := 101%positive.
Definition _md_len : ident := 89%positive.
Definition ___i64_shr : ident := 45%positive.
Definition _mbedtls_hmac_drbg_set_prediction_resistance : ident := 106%positive.
Definition _mbedtls_md_hmac_finish : ident := 80%positive.
Definition _reseed_counter : ident := 13%positive.
Definition ___builtin_va_arg : ident := 27%positive.
Definition _p : ident := 84%positive.
...
Definition _mbedtls_hmac_drbg_random_with_add : ident := 115%positive.
Definition _seedlen : ident := 100%positive.
Definition _use_len : ident := 114%positive.
Definition _dummy : ident := 20%positive.
Definition ___compcert_va_float64 : ident := 32%positive.
Definition _mbedtls_hmac_drbg_update : ident := 93%positive.
Definition _mbedtls_hmac_drbg_free : ident := 117%positive.
Definition _resistance : ident := 105%positive.
Definition _hmac : ident := 70%positive.
Definition ___builtin_annot_intval : ident := 24%positive.
Definition _ret : ident := 96%positive.
...
Definition _rounds : ident := 90%positive.
Definition _n : ident := 83%positive.
Definition _memcpy : ident := 61%positive.
Definition _mbedtls_md_context_t : ident := 11%positive.
Definition _mbedtls_hmac_drbg_random : ident := 116%positive.
Definition _mbedtls_hmac_drbg_seed_buf : ident := 97%positive.
Definition ___i64_utod : ident := 37%positive.
Definition _mbedtls_md_free : ident := 81%positive.
Definition _input : ident := 76%positive.
Definition _mbedtls_hmac_drbg_init : ident := 86%positive.
...
Definition _additional : ident := 87%positive.
Definition _ilen : ident := 77%positive.
Definition _mbedtls_md_setup : ident := 71%positive.
Definition _mbedtls_md_hmac_reset : ident := 75%positive.
Definition ___i64_dtos : ident := 34%positive.
Definition ___builtin_va_end : ident := 29%positive.
Definition _data_len : ident := 95%positive.
...
Definition f_mbedtls_zeroize := {|
  ...
  fn_temps := ((_p, (tptr (tvolatile tuchar))) ::
               (120%positive, (tptr (tvolatile tuchar))) ::
               (119%positive, tuint) :: nil);
  fn_body :=
(Ssequence
  ...
  (Sloop
    (Ssequence
      (Ssequence
        (Ssequence
          (Sset 119%positive (Etempvar _n tuint))
          (Sset _n
            (Ebinop Osub (Etempvar 119%positive tuint)
              (Econst_int (Int.repr 1) tint) tuint)))
        (Sifthenelse (Etempvar 119%positive tuint) Sskip Sbreak))
      (Ssequence
        (Ssequence
          (Sset 120%positive (Etempvar _p (tptr (tvolatile tuchar))))
          (Sset _p
            (Ebinop Oadd (Etempvar 120%positive (tptr (tvolatile tuchar)))
        ...
        (Sbuiltin None (EF_vstore Mint8unsigned)
          ...
          ((Eaddrof
             (Ederef (Etempvar 120%positive (tptr (tvolatile tuchar)))
...
Definition f_mbedtls_hmac_drbg_update := {|
  ...
  fn_temps := ((_md_len, tuint) :: (_rounds, tuchar) ::
               (123%positive, tint) :: (122%positive, tint) ::
               (121%positive, tuchar) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    ...
    (Sset _md_len (Etempvar 121%positive tuchar)))
  (Ssequence
    (Ssequence
      (Ssequence
        (Sifthenelse (Ebinop One (Etempvar _additional (tptr tuchar))
          ...
          (Sset 122%positive (Econst_int (Int.repr 0) tint)))
        (Sifthenelse (Etempvar 122%positive tint)
          (Sset 123%positive (Ecast (Econst_int (Int.repr 2) tint) tint))
          (Sset 123%positive (Ecast (Econst_int (Int.repr 1) tint) tint))))
      (Sset _rounds (Ecast (Etempvar 123%positive tint) tuchar)))
    (Ssequence
      (Sassign
        (Ederef
...
Definition f_mbedtls_hmac_drbg_seed_buf := {|
  ...
  fn_vars := nil;
  fn_temps := ((_ret, tint) :: (127%positive, tuchar) ::
               (126%positive, tuchar) :: (125%positive, tint) ::
               (124%positive, tint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Ssequence
      (Ssequence
        (Scall (Some 124%positive)
          ...
          ((Eaddrof
           ...
           (Econst_int (Int.repr 1) tint) :: nil))
        (Sset 125%positive (Etempvar 124%positive tint)))
      (Sset _ret (Etempvar 125%positive tint)))
    (Sifthenelse (Ebinop One (Ecast (Etempvar 125%positive tint) tint)
        ...
        ((Eaddrof
         ...
         (Efield
           (Ederef
             (Etempvar _ctx (tptr (Tstruct _mbedtls_hmac_drbg_context noattr)))
             (Tstruct _mbedtls_hmac_drbg_context noattr)) _V
           (tarray tuchar 32)) :: (Etempvar 126%positive tuchar) :: nil)))
    (Ssequence
      (Ssequence
        ...
        (Scall None
          ...
          ((Efield
           ...
           (Etempvar 127%positive tuchar) :: nil)))
      (Ssequence
        (Scall None
...
Definition f_mbedtls_hmac_drbg_reseed := {|
  ...
  fn_temps := ((_seedlen, tuint) :: (130%positive, tint) ::
               (129%positive, tint) :: (128%positive, tint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sifthenelse (Ebinop Ogt (Etempvar _len tuint)
                   (Econst_int (Int.repr 256) tint) tint)
      (Sset 128%positive (Econst_int (Int.repr 1) tint))
      (Sset 128%positive
        (Ecast
          (Ebinop Ogt
            (Ebinop Oadd
          ...
          ((Efield
           ...
           (Efield
             (Ederef
               ...
               (Tstruct _mbedtls_hmac_drbg_context noattr)) _entropy_len
             tuint) :: nil))
        (Sifthenelse (Ebinop One (Etempvar 129%positive tint)
                       (Econst_int (Int.repr 0) tint) tint)
              ...
              (Sset 130%positive
                (Ecast
                  (Ebinop One (Etempvar _len tuint)
                    (Econst_int (Int.repr 0) tint) tint) tbool))
              (Sset 130%positive (Econst_int (Int.repr 0) tint)))
...
Definition f_mbedtls_hmac_drbg_seed := {|
  ...
  fn_temps := ((_ret, tint) :: (_entropy_len, tuint) :: (_md_size, tuint) ::
               ...
               (135%positive, tint) :: (134%positive, tint) ::
               (133%positive, tuchar) :: (132%positive, tint) ::
               (131%positive, tint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Ssequence
      (Ssequence
        (Scall (Some 131%positive)
          ...
          ((Eaddrof
           ...
           (Etempvar _md_info (tptr (Tstruct _mbedtls_md_info_t noattr))) ::
           (Econst_int (Int.repr 1) tint) :: nil))
        (Sset 132%positive (Etempvar 131%positive tint)))
      (Sset _ret (Etempvar 132%positive tint)))
    (Sifthenelse (Ebinop One (Ecast (Etempvar 132%positive tint) tint)
                   (Econst_int (Int.repr 0) tint) tint)
      (Sreturn (Some (Etempvar _ret tint)))
      Sskip))
  (Ssequence
    (Ssequence
      (Scall (Some 133%positive)
        ...
        ((Etempvar _md_info (tptr (Tstruct _mbedtls_md_info_t noattr))) ::
         nil))
      (Sset _md_size (Etempvar 133%positive tuchar)))
    (Ssequence
      (Scall None
        (Evar _mbedtls_md_hmac_starts (Tfunction
                                        (Tcons
                  ...
                  (Sifthenelse (Ebinop Ole (Etempvar _md_size tuint)
                    ...
                    (Sifthenelse (Ebinop Ole (Etempvar _md_size tuint)
                      ...
                      (Ssequence
                        ...
                        (Sset 134%positive
                          (Ecast (Etempvar 135%positive tint) tint)))
                      (Ssequence
                        (Sset 135%positive
                          (Ecast (Econst_int (Int.repr 32) tint) tint))
                        (Sset 134%positive
                          (Ecast (Etempvar 135%positive tint) tint)))))
                  (Sset _entropy_len (Etempvar 134%positive tint)))
                (Ssequence
                  (Sassign
                    (Efield
                      (Ederef
                        ...
                        (Ssequence
                          (Scall (Some 136%positive)
                            ...
                            ((Etempvar _ctx (tptr (Tstruct _mbedtls_hmac_drbg_context noattr))) ::
                             ...
                             (Etempvar _len tuint) :: nil))
                          (Sset 137%positive (Etempvar 136%positive tint)))
                        (Sset _ret (Etempvar 137%positive tint)))
                      (Sifthenelse (Ebinop One
                                     (Ecast (Etempvar 137%positive tint)
      ...
      (Scall (Some 138%positive)
        ...
        ((Efield
           (Efield
             ...
             (Tstruct _mbedtls_md_context_t noattr)) _md_info
           (tptr (Tstruct _mbedtls_md_info_t noattr))) :: nil))
      (Sset _md_len (Etempvar 138%positive tuchar)))
    (Ssequence
                ...
                (Sifthenelse (Ebinop One
                  ...
                  (Sifthenelse (Ebinop Oeq
                    ...
                    (Ssequence
                      ...
                      (Sset 141%positive
                        (Ecast (Etempvar 141%positive tint) tbool))))
                  ...
                  (Sifthenelse (Ebinop One
                    ...
                    (Sset 142%positive
                      (Ecast
                        (Ebinop One (Etempvar _add_len tuint)
                          (Econst_int (Int.repr 0) tint) tint) tbool))
                    (Sset 142%positive (Econst_int (Int.repr 0) tint)))
                  (Sifthenelse (Etempvar 142%positive tint)
                    (Scall None
                      (Evar _mbedtls_hmac_drbg_update (Tfunction
                                                        (Tcons
                                                          (tptr (Tstruct _mbedtls_hmac_drbg_context noattr))
                  ...
                  (Swhile
                    ...
                    (Ssequence
                      (Ssequence
                        ...
                        (Sset _use_len (Etempvar 143%positive tuint)))
                      (Ssequence
                        (Scall None
                          (Evar _mbedtls_md_hmac_reset (Tfunction
                                                         (Tcons
...
(_main :: _mbedtls_hmac_drbg_free :: _mbedtls_hmac_drbg_random ::
 ...
 _mbedtls_hmac_drbg_update :: _mbedtls_hmac_drbg_init :: _mbedtls_md_free ::
