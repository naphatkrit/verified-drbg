...
Require Import HMAC_DRBG_working_state.
...
Definition HMAC_DRBG_instantiate_algorithm (HMAC: list Z -> list Z -> list Z) (entropy_input nonce personalization_string: list Z): HMAC_DRBG_working_state :=
